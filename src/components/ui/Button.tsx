...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        "bg-surface-elevated text-foreground border border-border hover:bg-surface hover:border-border-light focus:ring-border-light",
      accent:
        "bg-accent text-white hover:bg-accent-hover focus:ring-accent",
      ghost:
        "bg-transparent text-foreground hover:bg-surface-elevated focus:ring-border",
      danger:
